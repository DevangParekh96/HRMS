...
<head>
  ...
  <link href="{{asset('css/styleforpage.css')}}" rel="stylesheet">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item ">
        <a class="sidebar-toggler flex-shrink-0" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars "></i></a>
      </li>
      ...
      <!-- Messages Dropdown Menu sidebar-toggler flex-shrink-0 -->
    ...
    <div class="sidebar">
      ...
      <div class="info ">
        <a href="/dashboard" class="d-block">
              <i class="text-white fas fa-tachometer-alt">&nbsp; D A S H B O A R D
           </i>
        </a>
        </div>
      </div><!-- Sidebar Menu -->
