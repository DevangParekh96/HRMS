      ...
      <div class="container-fluid">
        <div class="row">
                  ...
                  <!-- /.tab-pane -->
                    ...
                    <form class="form-horizontal"action="{{route('user.store')}}" method="post" enctype="multipart/form-data" style="width: 100%;">
                    @csrf
                ...
                @enderror
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="email" class="form-control" id="email" placeholder="Enater E-mail">
                        </div>
                      </div>
                      @error('email')
                <p class='text-danger inputerror'>{{ $message }} </p>
                @enderror
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="mno" class="form-control" id="phone" placeholder="Enter phone number"/>
                        </div>
                      </div>
                      @error('mno')
                <p class='text-danger inputerror'>{{ $message }} </p>
                ...
                @enderror
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" name="add1" class="form-control" id="stock" placeholder="Enter Address" ></textarea>
                        </div>
                      </div>
                      @error('add1')
                <p class='text-danger inputerror'>{{ $message }} </p>
                @enderror
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" name="add2" class="form-control" id="stock" placeholder="Enter Address" ></textarea>
                        </div>
                      </div>
                      @error('add2')
                <p class='text-danger inputerror'>{{ $message }} </p>
                @enderror
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="dept" class="form-control" id="dept" placeholder="Enter Department Name"/>
                        </div>
                      </div>
                      @error('dept')
                <p class='text-danger inputerror'>{{ $message }} </p>
                @enderror
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="designation" class="form-control" id="desig" placeholder="Enter Your Designation"/>
                        </div>
                      </div>
                      @error('designation')
                <p class='text-danger inputerror'>{{ $message }} </p>
